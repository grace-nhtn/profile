export default {
  ...
  sections: {
    experience: {
      title: 'Kinh nghiệm',
      subtitle: 'Một số điểm chính trong quá trình làm việc gần đây.',
    },
    education: {
      title: 'Học vấn',
      subtitle: 'Nền tảng chuyên môn tại UIT.',
    },
    skills: {
      title: 'Kỹ năng',
      subtitle: 'Ngôn ngữ, framework và công cụ đã dùng trong dự án.',
    },
    projects: {
      title: 'Dự án tiêu biểu',
      subtitle: 'Các dự án React/Ant Design đã tham gia.',
    },
    certifications: {
      title: 'Chứng chỉ',
      subtitle: 'Chứng chỉ chuyên môn và thành tựu.',
    },
    contact: {
      title: 'Liên hệ',
